...
namespace lve
{
    ...
    VkCommandBuffer LveRenderer::beginFrame()
    {
        ...
        const VkResult result = lveSwapChain->acquireNextImage(&currentImageIndex);
    ...
    void LveRenderer::endFrame()
    {
        ...
        if (const VkResult result = lveSwapChain->submitCommandBuffers(&commandBuffer, &currentImageIndex);
            result == VK_ERROR_OUT_OF_DATE_KHR || result == VK_SUBOPTIMAL_KHR || lveWindow.wasWindowResized())
        {
