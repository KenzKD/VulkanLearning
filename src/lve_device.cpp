...
namespace lve
{
    ...
    uint32_t LveDevice::findMemoryType(const uint32_t typeFilter, const VkMemoryPropertyFlags properties) const
    {
    ...
    VkCommandBuffer LveDevice::beginSingleTimeCommands() const
    {
    ...
    void LveDevice::hasGflwRequiredInstanceExtensions() const
    {
        ...
        for (const std::vector<const char*> requiredExtensions = getRequiredExtensions(); const char* const& required :
             requiredExtensions)
        {
